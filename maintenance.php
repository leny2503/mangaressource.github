...
?>
<body onselectstart="return false" oncontextmenu="return false" ondragstart="return false" onMouseOver="window.status='non au F12'; return true;" ><script language="JavaScript"><!-- Disable function disableselect(e){ return false } function reEnable(){ return true }</script>
<meta charset="utf-8">
...
<div class="container">
  ...
  <p>Les données du site sont en cours de modification !!</p>
  <p>Veuillez patienter ou revenir plus tard !</p>
  </div>
</div>
<a href="auth/index.php" style="position: absolute;bottom: 10px;left: 10px;">Connexion admin</a>
<style type="text/css">
  html{
    cursor: default;
  }
...
.spin-one {
  -webkit-animation: spin-one 4s infinite linear;
  animation: spin-one 4s infinite linear;
}
